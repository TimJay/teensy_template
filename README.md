...
===============================
**teensy_template** provides an basic way to get up and running with developing software for the Teensy 3.1 microcontroller using Eclipse 4 IDE.

## Usage
### Required Eclipse Plug-In
Install GNU ARM Eclipse Plug-in from http://gnuarmeclipse.livius.net/blog/plugins-install/ into Eclipse (I tested on 4.4/Luna)
